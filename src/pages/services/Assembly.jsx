...
// Data structure for the assembly plans
const plansData = [
  {
    name: "Quick Assembly",
    priceMonthly: 1200,
    features: [
      "Small furniture assembly (e.g., nightstands, chairs)",
      "Simple shelf installation (up to 2 units)",
      "Picture hanging/Mirror mounting (up to 5 items)",
  ...
  },
  {
    name: "Standard Setup",
    priceMonthly: 3500,
    priceDiscountedMonthly: 3200, // Monthly Discount
    features: [
      "Medium furniture assembly (e.g., dressers, tables)",
      "Office desk and chair setup",
      "Fitness equipment assembly (basic treadmills/bikes)",
      "IKEA/Modular furniture expertise",
      "Cable management assistance",
    ],
  },
  {
    name: "Full Home Build",
    priceMonthly: 5500,
    priceDiscountedMonthly: 5000, // Monthly Discount
    features: [
      "Large furniture assembly (e.g., wardrobes, sectional sofas)",
      "Custom wall unit installation",
      "Complex fitness equipment setup (e.g., home gyms)",
      "Multiple room service included",
      "Haul away of packaging materials",
    ],
  },
];

// Helper component for the checkmark SVG
const CheckIcon = ({ className = "w-6 h-6 text-indigo-600" }) => (
  <svg
...
const Assembly = () => {
  ...
  const color = "indigo"; // Theme color for Assembly
        ...
        <div className="container mx-auto p-4 sm:p-10">
          <div className="mb-16 space-y-4 text-center">
            ...
            <p className="px-4 sm:px-8 lg:px-24">
              Hassle-free assembly and setup services for all your home and
              office furniture.
            </p>
